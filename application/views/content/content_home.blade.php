  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="{{base_url('/assets/images/as.png')}}" alt="Los Angeles" style="width:100%;height:30%">
      </div>

      <div class="item">
        <img src="{{base_url('/assets/images/user.png')}}" alt="Chicago" style="width:100%;height:30%">
      </div>
    
      <div class="item">
        <img src="{{base_url('/assets/images/as.png')}}" alt="New york" style="width:100%;height:30%">
      </div>
    </div>
